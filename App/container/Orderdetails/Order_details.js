...
//   // const shopping = useSelector(state => state.product);
...
//     dispatch(getcolor());
//   }, [])
//   // console.log("aaaaaaaaaa", route.params);


//   // const carddata = shopping.products.filter((v) =>
...
//           <Text style={styles.Colortext}>color:<Text style={styles.colorsize}>{colors.color.find((v1) => v.Color === v1.id)?.name}</Text></Text>
